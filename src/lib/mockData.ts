import { DSAProblem, CompanyPrepTrack, UserProfile, MockInterviewSession, ResumeAnalysis } from '../types';
...
export const mockCompanies: CompanyPrepTrack[] = [
...
export const mockInterviews: MockInterviewSession[] = [
